...
> Add notes here: Overall ecosystem health, climate change/ eutrophication
...
```{r, results = "hide"}
vignette("dplyr") #Fancy help document
```
...
NTL.phys.data.90.99<-filter(NTL.phys.data, lakename=="Tuesday Lake" 
...
NTL.phys.data.temps2 <- select(NTL.phys.data, -lakename)
```
### Mutate
