...
NvsP <-
  ...
  geom_point() +
  geom_smooth(method = lm) + #Line of best fit, method = linear model
  geom_abline(aes(slope = 16, intercept = 0)) #Just plotting a line specified by slope and intercept
print(NvsP)
